...
function configureDRM() {
    player.ready(function () {
        ...
        if ('FairPlay' === drmType) {
            ...
            Console_Log("No DRM supported in this browser");
        }
...
function videoAddEventListener(eventType, func){
    player.addEventListener(eventType, func);
}

function videoRemoveEventListener(eventType, func){
    player.removeEventListener(eventType, func);
}



function videoRemoveEventListener(func){
    player.off('timeupdate', func);
}


checkBrowser();

document.addEventListener('DOMContentLoaded', configureDRM);
