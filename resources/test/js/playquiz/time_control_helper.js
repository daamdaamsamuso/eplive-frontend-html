...
const timeInit = async () => {
    ...
    serverTime.serverTime = dateNow;
    serverTime.syncTime = dateNow;
    serverTime.gap = 0;

    const startBuffer = 1000 * 10;
    quizTime.startTimeMS = dateNow + startBuffer;
    quizTime.endTimeMS = dateNow + startBuffer + 557*1000 ;
    //For TEST PAGE : end
