...
function checkWindow() {
    ...
    if(navigator.userAgent.toLowerCase().indexOf('crios')>-1){
        //크롬 IOS, 크롬자체에 리사이즈 버그가있어서 제외하기로함
        if(ipad_portrait)
        {
...
//열기 다음회차 정보
    ...
    onDisplay(document.getElementsByClassName("dv_schedule_2st"),"none"); //2회차
    onDisplay(document.getElementsByClassName("dv_schedule_last"),"block"); //마지막
